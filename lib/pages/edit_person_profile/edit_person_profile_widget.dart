...
class EditPersonProfileWidget extends StatefulWidget {
  const EditPersonProfileWidget({
    super.key,
    this.nome,
    this.cidade,
  });
  ...
  @override
  State<EditPersonProfileWidget> createState() =>
            ...
            Padding(
              ...
              child: FlutterFlowDropDown<String>(
                controller: _model.stateValueController ??=
                  ...
                  _model.stateValue ??= 'Escolha um estado',
                ),
                options: const [
                  'AC',
                  'AL',
